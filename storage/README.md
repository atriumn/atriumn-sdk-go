...
// Alternatively, use the convenience method with just the S3 key
downloadResp, err := client.GenerateDownloadURLFromKey(ctx, "tenant-123/files/document.pdf")
if err != nil {
    // Handle error
}
```
...
func main() {
    ...
    downloadResp, err := storageClient.GenerateDownloadURLFromKey(ctx, s3Key)
    if err != nil {
